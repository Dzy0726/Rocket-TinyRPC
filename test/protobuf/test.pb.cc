...
static void InitDefaultsscc_info_ResponseCode_test_2eproto() {
  ...
  {
    void* ptr = &::fixbug::_ResponseCode_default_instance_;
    new (ptr) ::fixbug::ResponseCode();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::ResponseCode::InitAsDefaultInstance();
}
...
ResponseCode::ResponseCode()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.ResponseCode)
}
...
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.ResponseCode)
  GOOGLE_DCHECK_NE(&from, this);
  const ResponseCode* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ResponseCode>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.ResponseCode)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.ResponseCode)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.ResponseCode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void LoginResponse::InitAsDefaultInstance() {
  ::fixbug::_LoginResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResponseCode*>(
      ::fixbug::ResponseCode::internal_default_instance());
}
class LoginResponse::_Internal {
 public:
  static const ::fixbug::ResponseCode& result(const LoginResponse* msg);
};
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_result()) {
    result_ = new ::fixbug::ResponseCode(*from.result_);
  } else {
    result_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.LoginResponse)
  ...
  if (from.has_result()) {
    _internal_mutable_result()->::fixbug::ResponseCode::MergeFrom(from._internal_result());
  }
  if (from.success() != 0) {
...
void GetFriendListsResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListsResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResponseCode*>(
      ::fixbug::ResponseCode::internal_default_instance());
}
class GetFriendListsResponse::_Internal {
 public:
  static const ::fixbug::ResponseCode& result(const GetFriendListsResponse* msg);
};
