...
class LoginResponse :
 ...
 public:
  ...
  // .fixbug.ResponseCode result = 1;
  bool has_result() const;
  private:
  bool _internal_has_result() const;
  public:
  void clear_result();
  const ::fixbug::ResponseCode& result() const;
  ::fixbug::ResponseCode* release_result();
  ::fixbug::ResponseCode* mutable_result();
  void set_allocated_result(::fixbug::ResponseCode* result);
  private:
  const ::fixbug::ResponseCode& _internal_result() const;
  ::fixbug::ResponseCode* _internal_mutable_result();
  public:
...
// bytes errMessage = 2;
inline void ResponseCode::clear_errmessage() {
  errmessage_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& ResponseCode::errmessage() const {
  // @@protoc_insertion_point(field_get:fixbug.ResponseCode.errMessage)
  return _internal_errmessage();
}
inline void ResponseCode::set_errmessage(const std::string& value) {
  _internal_set_errmessage(value);
  // @@protoc_insertion_point(field_set:fixbug.ResponseCode.errMessage)
}
inline std::string* ResponseCode::mutable_errmessage() {
  // @@protoc_insertion_point(field_mutable:fixbug.ResponseCode.errMessage)
  return _internal_mutable_errmessage();
}
inline const std::string& ResponseCode::_internal_errmessage() const {
  return errmessage_.GetNoArena();
}
inline void ResponseCode::_internal_set_errmessage(const std::string& value) {
  
  errmessage_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ResponseCode::set_errmessage(std::string&& value) {
  
  errmessage_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.ResponseCode.errMessage)
}
inline void ResponseCode::set_errmessage(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  errmessage_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.ResponseCode.errMessage)
}
inline void ResponseCode::set_errmessage(const void* value, size_t size) {
  
  errmessage_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.ResponseCode.errMessage)
}
inline std::string* ResponseCode::_internal_mutable_errmessage() {
  
  return errmessage_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ResponseCode::release_errmessage() {
  // @@protoc_insertion_point(field_release:fixbug.ResponseCode.errMessage)
  
  return errmessage_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ResponseCode::set_allocated_errmessage(std::string* errmessage) {
...
inline const ::fixbug::ResponseCode& LoginResponse::_internal_result() const {
  const ::fixbug::ResponseCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResponseCode*>(
      &::fixbug::_ResponseCode_default_instance_);
}
inline const ::fixbug::ResponseCode& LoginResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.result)
  return _internal_result();
}
inline ::fixbug::ResponseCode* LoginResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.result)
  
  ::fixbug::ResponseCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResponseCode* LoginResponse::_internal_mutable_result() {
  
  if (result_ == nullptr) {
    auto* p = CreateMaybeMessage<::fixbug::ResponseCode>(GetArenaNoVirtual());
    result_ = p;
  }
  return result_;
}
inline ::fixbug::ResponseCode* LoginResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.result)
  return _internal_mutable_result();
}
inline void LoginResponse::set_allocated_result(::fixbug::ResponseCode* result) {
...
inline const ::fixbug::ResponseCode& GetFriendListsResponse::_internal_result() const {
  const ::fixbug::ResponseCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResponseCode*>(
      &::fixbug::_ResponseCode_default_instance_);
}
inline const ::fixbug::ResponseCode& GetFriendListsResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.result)
  return _internal_result();
}
inline ::fixbug::ResponseCode* GetFriendListsResponse::release_result() {
...
inline ::fixbug::ResponseCode* GetFriendListsResponse::_internal_mutable_result() {
...
inline ::fixbug::ResponseCode* GetFriendListsResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.result)
  return _internal_mutable_result();
}
inline void GetFriendListsResponse::set_allocated_result(::fixbug::ResponseCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
